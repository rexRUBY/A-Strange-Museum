...
public class EndingPlayer extends JLabel implements Tile, Moveable {
    ...
    //Constructor
    public EndingPlayer() throws UnsupportedAudioFileException, LineUnavailableException, IOException {
        getPlayerImage();
        defaultSetting();
    }
    ...
    public void gameStart() throws UnsupportedAudioFileException, LineUnavailableException, IOException, InterruptedException {
        int x = getX();
        int y = getY();
        ...
        if ((x > 715 && x < 730) && (y > 160  && y < 250)) {
            ...
            if (ending == true) {
                ending =false;
                EndingCredit.getInstance();
                EndingIntro.endingFrame.repaint();
                EndingIntro.endingFrame.setVisible(false);
            }
        }
    }
    ...
    public void addEventListener(EndingPlayer player, JFrame frame) {
